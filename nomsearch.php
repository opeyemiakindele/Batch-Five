...
<html lang="en">
  <head>
    ...
    <title>Search Nominee | Kwara Corpers Award </title>
...
================================================== -->
  <body>
    ...
    <div class="header">			
        ...
        <div class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
			...
			<li><a href="searchnom.html">Refresh</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
	</div>
   ...
   <div class="jumbotron">
<div class="container">
<h1>Search Nominee details</h1>
<p>Simple Search Page</p>
<p><a class="btn btn-brand" role="button">
Search</a>
</p>
</div>
</div>
		...
		<div class="serviceBlock">
					...
					<div class="col-md-offset-4 col-md-4">
					  ...
					  <div class="form-group">
						<input type="text" class="form-control" name="search_text" id="search_text" placeholder="Search for Nominee...">
...
<script>
    $(document).ready(function() {
      	$('input#search_text').bind('keyup', function( event ){
		var txt = $(this).val();
		if(txt != '')
		{
			$.post(
